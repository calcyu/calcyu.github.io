...
git init
#Clone远程版本库
git clone git@github.com:user:xxxx.git
#添加远程版本库origin，语法为 git remote add [shortname] [url]
git remote add origin git@github.com:user:xxxx.git
#clone指定分支代码
git clone -b gh-pages https://github.com/user/xxxxx
```
