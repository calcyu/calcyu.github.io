...
因为熔断只是作用在服务调用这一端，因此我们根据上一篇的示例代码只需要改动spring-cloud-consumer项目相关代码就可以。因为，spring-cloud-starter-netflix-eureka-client中已经依赖了Hystrix所以在maven配置上不用做任何改动。

> 为了体现区别，我这里创建了一个新的项目`spring-cloud-hystrix`
...
创建HelloRemoteImpl类继承与HelloRemote实现回调的方法
...
实现Feign调用的接口，定义fallback属性，很简单吧。
...
**[示例代码-github](https://github.com/calcyu/spring-cloud-examples/tree/master/Lesson03/spring-cloud-hystrix)**
